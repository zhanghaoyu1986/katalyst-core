...
func (ic *IrqTuningController) classifyNicsByThroughputFirstTime(nics []*machine.NicBasicInfo) ([]*machine.NicBasicInfo, []*machine.NicBasicInfo) {
...
func (ic *IrqTuningController) syncNics() error {
	...
	normalThroughputNics, lowThroughputNics := ic.classifyNicsByThroughputFirstTime(nics)
